...
namespace MABDBWeb
{
    ...
    public partial class InvestorApplicantsNewAll : System.Web.UI.Page
    {
        ...
        private int UploadInvestorApplicsCSV(string csvPath)
        {
            ...
            impCols = new DataColumn[144]; //total 138 columns in the table
            ...
            impCols[5] = new DataColumn("Primary_OtherNames", typeof(string));
            impCols[6] = new DataColumn("Other_OtherNames", typeof(string));
            impCols[7] = new DataColumn("Primary_LastName", typeof(string));                                   
            impCols[8] = new DataColumn("Other_LastName", typeof(string));
            impCols[9] = new DataColumn("Primary_Title", typeof(string));
            impCols[10] = new DataColumn("Other_Title", typeof(string));
            impCols[11] = new DataColumn("IsCompany", typeof(string));
            impCols[12] = new DataColumn("CompanyName", typeof(string));
            impCols[13] = new DataColumn("CompanyABN", typeof(string));
            impCols[14] = new DataColumn("CompanyACN", typeof(string));
            impCols[15] = new DataColumn("Primary_CompRole", typeof(string));
            impCols[16] = new DataColumn("Primary_DOB", typeof(DateTime));
            impCols[17] = new DataColumn("Other_DOB", typeof(DateTime));
            impCols[18] = new DataColumn("Primary_Gender", typeof(string));
            impCols[19] = new DataColumn("Other_Gender", typeof(string));
            impCols[20] = new DataColumn("Primary_MaritalStats", typeof(string));
            impCols[21] = new DataColumn("Other_MaritalStats", typeof(string));
            impCols[22] = new DataColumn("Email", typeof(string)); // primary
            impCols[23] = new DataColumn("Other_Email", typeof(string)); // other
            impCols[24] = new DataColumn("Primary_HomePhone", typeof(string)); // other
            impCols[25] = new DataColumn("Other_HomePhone", typeof(string)); // other            
            impCols[26] = new DataColumn("Mobile", typeof(string)); // primary
            impCols[27] = new DataColumn("Other_Mobile", typeof(string)); // mobile number other
            impCols[28] = new DataColumn("Primary_PassportNo", typeof(string)); //"Passport Number Primary Applicant",
            impCols[29] = new DataColumn("Other_PassportNo", typeof(string)); //"Passport Number Other Applicant",
            impCols[30] = new DataColumn("Primary_PassportCountry", typeof(string));
            //"Passport Country of Issue - Primary Applicant",
            impCols[31] = new DataColumn("Other_PassportCountry", typeof(string));
            //"Passport Country of Issue - Other Applicant",
            impCols[32] = new DataColumn("Primary_DriversLicenceNo", typeof(string));
            //"Drivers Licence Number Primary Applicant","Drivers Licence Number Other Applicant",
            impCols[33] = new DataColumn("Other_DriversLicenceNo", typeof(string));
            //"Drivers Licence State of Issue Primary Applicant",
            impCols[34] = new DataColumn("Primary_DriversLicenceState", typeof(string));
            //"Driver's Licence State of Issue Other Applicant"
            impCols[35] = new DataColumn("Other_DriversLicenceState", typeof(string));
            impCols[36] = new DataColumn("Primary_AUCitizenStat", typeof(string));
            impCols[37] = new DataColumn("Other_AUCitizenStat", typeof(string));
            // <- impCols[14] = new DataColumn("Other_Dependants", typeof(string));

            impCols[38] = new DataColumn("Primary_Res_Street1", typeof(string));
            impCols[39] = new DataColumn("Primary_Res_Street2", typeof(string));
            //impCols 32] = new DataColumn("Primary_Res_City", typeof(string));
            impCols[40] = new DataColumn("Primary_Res_Suburb", typeof(string));            
            impCols[41] = new DataColumn("Primary_Res_State", typeof(string));
            impCols[42] = new DataColumn("Primary_Res_PostCode", typeof(string));
            impCols[43] = new DataColumn("Primary_Res_Country", typeof(string));
            // 
            impCols[44] = new DataColumn("Other_Res_Street1", typeof(string));
            impCols[45] = new DataColumn("Other_Res_Street2", typeof(string));
            impCols[46] = new DataColumn("Other_Res_Suburb", typeof(string));
            impCols[47] = new DataColumn("Other_Res_State", typeof(string));
            impCols[48] = new DataColumn("Other_Res_PostCode", typeof(string));
            impCols[49] = new DataColumn("Other_Res_Country", typeof(string));

            impCols[50] = new DataColumn("Primary_CurrResidStatus", typeof(string)); // primary
            impCols[51] = new DataColumn("Other_CurrResidStatus", typeof(string)); // other
            impCols[52] = new DataColumn("Primary_YrsCurrAddr", typeof(string)); // primary
            impCols[53] = new DataColumn("Other_YrsCurrAddr", typeof(string)); // other

            //Previous residential address Primary and Other applicants
            impCols[54] = new DataColumn("PrimPrev_Res_Street1", typeof(string));
            impCols[55] = new DataColumn("PrimPrev_Res_Street2", typeof(string));
            impCols[56] = new DataColumn("PrimPrev_Res_Suburb", typeof(string));
            impCols[57] = new DataColumn("PrimPrev_Res_State", typeof(string));
            impCols[58] = new DataColumn("PrimPrev_Res_PostCode", typeof(string));
            impCols[59] = new DataColumn("PrimPrev_Res_Country", typeof(string));
            // 
            impCols[60] = new DataColumn("OthPrev_Res_Street1", typeof(string));
            impCols[61] = new DataColumn("OthPrev_Res_Street2", typeof(string));
            impCols[62] = new DataColumn("OthPrev_Res_Suburb", typeof(string));
            impCols[63] = new DataColumn("OthPrev_Res_State", typeof(string));
            impCols[64] = new DataColumn("OthPrev_Res_PostCode", typeof(string));
            impCols[65] = new DataColumn("OthPrev_Res_Country", typeof(string));
            impCols[66] = new DataColumn("YrsPrevAddr", typeof(string)); // primary
            // years at previous address Other
            impCols[67] = new DataColumn("Other_YrsPrevAddr", typeof(string)); // primary
            impCols[68] = new DataColumn("PrevResStatus", typeof(string)); // Other
            // pre reidential status other
            impCols[69] = new DataColumn("Other_PrevResStatus", typeof(string)); // Other
            impCols[70] = new DataColumn("IsSmoker", typeof(string));
            impCols[71] = new DataColumn("HasPrivateHealthIns", typeof(string));
            impCols[72] = new DataColumn("CurrOccupType", typeof(string)); // Primary    
            impCols[73] = new DataColumn("CurrEmploymentStatus", typeof(string));
            impCols[74] = new DataColumn("YrsCurrEmployer", typeof(string));
            impCols[75] = new DataColumn("YrsPrevEmployer", typeof(string));
            impCols[76] = new DataColumn("Other_CurrOccupType", typeof(string)); // Other
            impCols[77] = new DataColumn("Primary_IncomeMoAT", typeof(string));
            impCols[78] = new DataColumn("Other_IncomeMoAT", typeof(string));
            // Primary Applicant $ Business Income (Personal Drawings/Share of Profits) after PAYG tax pa $",
            impCols[79] = new DataColumn("Primary_BusIncomeAPAYGTaxPA", typeof(string));
            //"Other Applicant $ Business Income (Personal Drawings/Share of Profits) after PAYG tax pa",
            impCols[80] = new DataColumn("Other_BusIncomeAPAYGTaxPA", typeof(string));
            //"Other $ Income per year - Primary Applicant",
            impCols[81] = new DataColumn("Primary_OtherIncomePA", typeof(string));
            //"Other $ Income per year - Other Applicant",
            impCols[82] = new DataColumn("Other_OtherIncomePA", typeof(string));
            //"Type of Other Income Primary Applicant (ie, dividends, rent, none)",
            impCols[83] = new DataColumn("Primary_OtherIncomeType", typeof(string));
            //"Type of other Income Other Applicant (ie, dividends, rent, none)"
            impCols[84] = new DataColumn("Other_OtherIncomeType", typeof(string));
            impCols[85] = new DataColumn("HouseholdIncomeGrossPA", typeof(string));
            //remov
            //Primary Applicant Home and/ or Investment loans (list all) 1",
            impCols[86] = new DataColumn("Primary_HomeLoanList", typeof(string));
            //"Other Applicant Home and/ or Investment loans (list all)",
            impCols[87] = new DataColumn("Other_HomeLoanList", typeof(string));
            //"Primary Applicant Car or Personal loans (list all) 1",
            impCols[88] = new DataColumn("Primary_PersonalLoansList", typeof(string));
            //"Other Applicant Car or Personal loans (list all)",
            impCols[89] = new DataColumn("Other_PersonalLoansList", typeof(string));
            //"Primary Applicant Credit and/ or Store(eg, Myer, David Jones) cards(list all) 1",
            impCols[90] = new DataColumn("Primary_CreditCardList", typeof(string));
            //"Other Applicant Credit and/ or Store(eg, Myer, David Jones) cards(list all)",
            impCols[91] = new DataColumn("Other_CreditCardList", typeof(string));
            //"Rent/Board per month ($)",
            impCols[92] = new DataColumn("RentPM", typeof(string));
            //"Property Assets & Liabilities for Primary Applicant: 1",
            impCols[93] = new DataColumn("Primary_PropertyAssets", typeof(string));
            impCols[94] = new DataColumn("Other_PropertyAssets", typeof(string));
            impCols[95] = new DataColumn("Primary_OtherAssetsList", typeof(string));
            impCols[96] = new DataColumn("Other_OtherAssetsList", typeof(string));
            impCols[97] = new DataColumn("Primary_OtherLiabilitiesList", typeof(string));
            impCols[98] = new DataColumn("Other_OtherLiabilitiesList", typeof(string));
            ...
            impCols[99] = new DataColumn("HasReadPO6", typeof(string));
            impCols[100] = new DataColumn("HasAgreedPrivacy", typeof(string));
            impCols[101] = new DataColumn("HasReqestedPriority", typeof(string));
            
            //           has read PAC Licence Agreement."
            // Created by UserID
            impCols[102] = new DataColumn("UserId", typeof(string));
            impCols[103] = new DataColumn("EntryId", typeof(string));
            impCols[104] = new DataColumn("EntryDate", typeof(DateTime));
            //"Source Url",
            impCols[105] = new DataColumn("SourceURL", typeof(string));
            //"Transaction Id", 
            impCols[106] = new DataColumn("TransactionId", typeof(string));

            impCols[107] = new DataColumn("CreatedUTC", typeof(DateTime));
            impCols[108] = new DataColumn("HasAgreedPACLicence", typeof(string));
            impCols[109] = new DataColumn("CreatedBy", typeof(string));
            // ignored columns
            // columns not populated
            int maxImportedColId = 103;

            
            impCols[110] = new DataColumn("LookingLocation", typeof(string));
            impCols[111] = new DataColumn("FoundLocation", typeof(string));
            impCols[112] = new DataColumn("Property_Street1", typeof(string));
            impCols[113] = new DataColumn("Property_Street2", typeof(string));
            impCols[114] = new DataColumn("Property_Suburb", typeof(string));
            impCols[115] = new DataColumn("Property_State", typeof(string));
            impCols[116] = new DataColumn("Property_PostCode", typeof(string));
            impCols[117] = new DataColumn("Property_Vendor", typeof(string));
            impCols[118] = new DataColumn("Property_Country", typeof(string));
            impCols[119] = new DataColumn("Property_AgentDetails", typeof(string));
            impCols[120] = new DataColumn("Primary_Dependants", typeof(string));            
            impCols[121] = new DataColumn("CondDecision", typeof(DateTime));
            impCols[122] = new DataColumn("Other_Dependants", typeof(string));
            impCols[123] = new DataColumn("CondDecisionBy", typeof(string));            
            impCols[124] = new DataColumn("ModifiedBy", typeof(string));
            impCols[125] = new DataColumn("Modified", typeof(string));
            impCols[126] = new DataColumn("RowVersion", typeof(string));
            impCols[127] = new DataColumn("InvestorApplicant_AssquireInvestor", typeof(string));
            impCols[128] = new DataColumn("InvestorApplication_Gender", typeof(string));
            impCols[129] = new DataColumn("EstSpend", typeof(string));
            impCols[130] = new DataColumn("AutoRejected", typeof(string));            
            impCols[131] = new DataColumn("AutoRejecetedBy", typeof(string));            
            impCols[132] = new DataColumn("AutoAccepted", typeof(string));
            impCols[133] = new DataColumn("AutoAcceptedBy", typeof(string));            
            impCols[134] = new DataColumn("CondCreditDecision", typeof(Boolean));
            impCols[135] = new DataColumn("CondCreditDecisionInformed", typeof(Boolean));
            impCols[136] = new DataColumn("CondCreditDecisionInformedBy", typeof(Boolean));
            impCols[137] = new DataColumn("CondCreditDecisionBy", typeof(Boolean));
            impCols[138] = new DataColumn("AppAckLetterSent", typeof(Boolean));
            impCols[139] = new DataColumn("AppAckLetterSentBy", typeof(Boolean));
            impCols[140] = new DataColumn("ApplicantsNotes", typeof(Boolean));
            impCols[141] = new DataColumn("CondDecisionOfficeNotes", typeof(Boolean));
            impCols[142] = new DataColumn("AppliedLimit", typeof(Boolean));
            ...
            impCols[143] = new DataColumn("Id", typeof(int));
            impCols[143].AutoIncrement = true;
            impCols[143].AutoIncrementSeed = -1;
            impCols[143].AutoIncrementStep = -1;
